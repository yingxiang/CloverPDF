...
T: dict[str, tuple[str, str, str, str, str, str]] = {
    ...
    "Add PDFs": ("Add PDFs", "添加 PDF", "PDF 추가", "PDFを追加", "PDFs hinzufügen", "Добавить PDF"),
    ...
    "Output Name": ("Output Name", "输出名称", "출력 이름", "出力名", "Ausgabename", "Имя результата"),
    "Merge": ("Merge", "合并", "병합", "結合", "Zusammenführen", "Объединить"),
    "Merged PDF": ("Merged PDF", "合并后的 PDF", "병합된 PDF", "結合済みPDF", "Zusammengeführtes PDF", "Объединенный PDF"),
    "PDF Password": ("PDF Password", "PDF 密码", "PDF 암호", "PDFパスワード", "PDF-Passwort", "Пароль PDF"),
    "Move Up": ("Move Up", "上移", "위로 이동", "上へ移動", "Nach oben", "Переместить вверх"),
    "Move Down": ("Move Down", "下移", "아래로 이동", "下へ移動", "Nach unten", "Переместить вниз"),
