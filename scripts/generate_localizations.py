...
T: dict[str, tuple[str, str, str, str, str, str]] = {
    ...
    "PNG Merge": ("PNG Merge", "PNG合并", "PNG 병합", "PNG結合", "PNG-Zusammenführung", "Объединение PNG"),
    "JPG Merge": ("JPG Merge", "JPG合并", "JPG 병합", "JPG結合", "JPG-Zusammenführung", "Объединение JPG"),
    "Word Merge": ("Word Merge", "Word合并", "Word 병합", "Word結合", "Word-Zusammenführung", "Объединение Word"),
    "PDF to PDF": ("PDF to PDF", "PDF转PDF", "PDF를 PDF로", "PDFをPDFに変換", "PDF in PDF", "PDF в PDF"),
    "PDF to PNG": ("PDF to PNG", "PDF转PNG", "PDF를 PNG로", "PDFをPNGに変換", "PDF in PNG", "PDF в PNG"),
    "PDF to JPG": ("PDF to JPG", "PDF转JPG", "PDF를 JPG로", "PDFをJPGに変換", "PDF in JPG", "PDF в JPG"),
    "PDF to Word": ("PDF to Word", "PDF转Word", "PDF를 Word로", "PDFをWordに変換", "PDF in Word", "PDF в Word"),
    ...
    "Combine multiple files into one file. Export as PNG, JPG, PDF, or Word.": ("Combine multiple files into one file. Export as PNG, JPG, PDF, or Word.", "将多个文件合并成一个文件，支持导出 PNG、JPG、PDF、Word。", "여러 파일을 하나로 병합합니다. PNG, JPG, PDF, Word로 내보낼 수 있습니다.", "複数のファイルを1つに結合します。PNG、JPG、PDF、Wordに書き出せます。", "Mehrere Dateien zu einer Datei zusammenführen. Export als PNG, JPG, PDF oder Word.", "Объединяйте несколько файлов в один. Экспорт в PNG, JPG, PDF или Word."),
    "Convert files to other formats. Export as PNG, JPG, PDF, or Word.": ("Convert files to other formats. Export as PNG, JPG, PDF, or Word.", "将文件转换成其他格式，支持导出 PNG、JPG、PDF、Word。", "파일을 다른 형식으로 변환합니다. PNG, JPG, PDF, Word로 내보낼 수 있습니다.", "ファイルを別の形式に変換します。PNG、JPG、PDF、Wordに書き出せます。", "Dateien in andere Formate konvertieren. Export als PNG, JPG, PDF oder Word.", "Преобразуйте файлы в другие форматы. Экспорт в PNG, JPG, PDF или Word."),
    "Merge as PNG, JPG, PDF, or Word files": ("Merge as PNG, JPG, PDF, or Word files", "合并为PNG、JPG、PDF、Word文件", "PNG, JPG, PDF 또는 Word 파일로 병합", "PNG、JPG、PDF、Wordファイルに結合", "Als PNG-, JPG-, PDF- oder Word-Datei zusammenführen", "Объединить в файл PNG, JPG, PDF или Word"),
    "Export PNG, JPG, PDF, or Word files": ("Export PNG, JPG, PDF, or Word files", "导出PNG、JPG、PDF、Word文件", "PNG, JPG, PDF 또는 Word 파일로 내보내기", "PNG、JPG、PDF、Wordファイルを書き出す", "PNG-, JPG-, PDF- oder Word-Dateien exportieren", "Экспорт файлов PNG, JPG, PDF или Word"),
    "Scanned PDF: OCR will be used": ("Scanned PDF: OCR will be used", "扫描版 PDF：将使用 OCR", "스캔 PDF: OCR 사용", "スキャンPDF：OCRを使用します", "Gescanntes PDF: OCR wird verwendet", "Сканированный PDF: будет использовано OCR"),
    ...
    "Choose Conversion Output Folder": ("Choose Conversion Output Folder", "选择转换输出文件夹", "변환 출력 폴더 선택", "変換出力フォルダを選択", "Ausgabeordner für Konvertierung wählen", "Выберите папку для результатов преобразования"),
    ...
    "Economical": ("Economical", "经济实惠", "경제적", "お得", "Preiswert", "Выгодно"),
    "Limited-time discount": ("Limited-time discount", "限时折扣", "기간 한정 할인", "期間限定割引", "Zeitlich begrenzter Rabatt", "Скидка на ограниченный период"),
    "OK": ("OK", "好", "확인", "OK", "OK", "ОК"),
